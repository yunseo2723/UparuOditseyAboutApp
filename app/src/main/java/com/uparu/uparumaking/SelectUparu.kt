...
class SelectUparu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var newAdapter = CustomAdapter2(this@SelectUparu, sortedDataList)
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                if (newText != null) {
                    ...
                    val newAdapter = CustomAdapter2(this@SelectUparu, filteredDataList)
                    gridView.adapter = newAdapter
                }
                return true
            }
        ...
        gridView.setOnItemClickListener { _, _, position, _ ->
            ...
            val intent = Intent(this@SelectUparu, MainActivity6::class.java)

            if (selectedItem == "포리") {
                editor.putInt("changeUparu1", R.drawable.pori)
                editor.putString("changeType1", "숲")
                editor.apply()
            } else if (selectedItem == "두더루") {
                editor.putInt("changeUparu1", R.drawable.dudeoru)
                editor.putString("changeType1", "땅")
                editor.apply()
            } else if (selectedItem == "뿌루루") {
                editor.putInt("changeUparu1", R.drawable.bbururu)
                editor.putString("changeType1", "불")
                editor.apply()
            }else if (selectedItem == "듀파") {
                editor.putInt("changeUparu1", R.drawable.dupa)
                editor.putString("changeType1", "물")
                editor.apply()
            } else if (selectedItem == "우루루") {
                editor.putInt("changeUparu1", R.drawable.ururu)
                editor.putString("changeType1", "천둥")
                editor.apply()
            } else if (selectedItem == "츄파") {
                editor.putInt("changeUparu1", R.drawable.chupa)
                editor.putString("changeType1", "얼음")
                editor.apply()
            } else if (selectedItem == "젤로") {
                editor.putInt("changeUparu1", R.drawable.jello)
                editor.putString("changeType1", "매직")
                editor.apply()
            } else if (selectedItem == "용가루") {
                editor.putInt("changeUparu1", R.drawable.yongaru)
                editor.putString("changeType1", "바람")
                editor.apply()
            } else if (selectedItem == "뭉구루") {
                editor.putInt("changeUparu1", R.drawable.munguru)
                editor.putString("changeType1", "땅,숲")
                editor.apply()
            } else if (selectedItem == "또루루") {
                editor.putInt("changeUparu1", R.drawable.ddoruru)
                editor.putString("changeType1", "숲,땅")
                editor.apply()
            } else if (selectedItem == "프링") {
                editor.putInt("changeUparu1", R.drawable.pring)
                editor.putString("changeType1", "숲,불")
                editor.apply()
            } else if (selectedItem == "무무") {
                editor.putInt("changeUparu1", R.drawable.mumu)
                editor.putString("changeType1", "불,땅")
                editor.apply()
            } else if (selectedItem == "하쿠루") {
                editor.putInt("changeUparu1", R.drawable.hakuru)
                editor.putString("changeType1", "불,숲")
                editor.apply()
            } else if (selectedItem == "판판") {
                editor.putInt("changeUparu1", R.drawable.panpan)
                editor.putString("changeType1", "땅,불")
                editor.apply()
            } else if (selectedItem == "푸푸") {
                editor.putInt("changeUparu1", R.drawable.pupu)
                editor.putString("changeType1", "물,숲")
                editor.apply()
            } else if (selectedItem == "해롱") {
                editor.putInt("changeUparu1", R.drawable.haerong)
                editor.putString("changeType1", "숲,물")
                editor.apply()
            } else if (selectedItem == "페로") {
                editor.putInt("changeUparu1", R.drawable.pero)
                editor.putString("changeType1", "숲,천둥")
                editor.apply()
            } else if (selectedItem == "페페") {
                editor.putInt("changeUparu1", R.drawable.pepe)
                editor.putString("changeType1", "불,천둥")
                editor.apply()
            } else if (selectedItem == "메메") {
                editor.putInt("changeUparu1", R.drawable.meme)
                editor.putString("changeType1", "천둥,불")
                editor.apply()
            } else if (selectedItem == "용용") {
                editor.putInt("changeUparu1", R.drawable.yongyong)
                editor.putString("changeType1", "땅,천둥")
                editor.apply()
            } else if (selectedItem == "다람") {
                editor.putInt("changeUparu1", R.drawable.daram)
                editor.putString("changeType1", "불,천둥")
                editor.apply()
            } else if (selectedItem == "버비") {
                editor.putInt("changeUparu1", R.drawable.beobi)
                editor.putString("changeType1", "땅,숲")
                editor.apply()
            } else if (selectedItem == "앤티") {
                editor.putInt("changeUparu1", R.drawable.anti)
                editor.putString("changeType1", "숲,땅")
                editor.apply()
            } else if (selectedItem == "동크") {
                editor.putInt("changeUparu1", R.drawable.donk)
                editor.putString("changeType1", "불,땅")
                editor.apply()
            } else if (selectedItem == "시드") {
                editor.putInt("changeUparu1", R.drawable.seed)
                editor.putString("changeType1", "숲,불")
                editor.apply()
            } else if (selectedItem == "도롱") {
                editor.putInt("changeUparu1", R.drawable.dorong)
                editor.putString("changeType1", "천둥,숲")
                editor.apply()
            } else if (selectedItem == "포터") {
                editor.putInt("changeUparu1", R.drawable.poter)
                editor.putString("changeType1", "숲,천둥")
                editor.apply()
            } else if (selectedItem == "삼삼") {
                editor.putInt("changeUparu1", R.drawable.samsam)
                editor.putString("changeType1", "숲,천둥")
                editor.apply()
            } else if (selectedItem == "로로") {
                editor.putInt("changeUparu1", R.drawable.roro)
                editor.putString("changeType1", "숲,천둥")
                editor.apply()
            } else if (selectedItem == "푸드덕") {
                editor.putInt("changeUparu1", R.drawable.puddeok)
                editor.putString("changeType1", "천둥,불")
                editor.apply()
            } else if (selectedItem == "알리") {
                editor.putInt("changeUparu1", R.drawable.ali)
                editor.putString("changeType1", "천둥,숲")
                editor.apply()
            } else if (selectedItem == "초코럽") {
                editor.putInt("changeUparu1", R.drawable.chocolove)
                editor.putString("changeType1", "천둥,숲")
                editor.apply()
            } else if (selectedItem == "코코럽") {
                editor.putInt("changeUparu1", R.drawable.cocolove)
                editor.putString("changeType1", "천둥,숲")
                editor.apply()
            } else if (selectedItem == "러브럽") {
                editor.putInt("changeUparu1", R.drawable.lovelove)
                editor.putString("changeType1", "천둥,숲")
                editor.apply()
            } else if (selectedItem == "라플리") {
                editor.putInt("changeUparu1", R.drawable.raply)
                editor.putString("changeType1", "불,숲")
                editor.apply()
            } else if (selectedItem == "토토") {
                editor.putInt("changeUparu1", R.drawable.toto)
                editor.putString("changeType1", "물,불")
                editor.apply()
            } else if (selectedItem == "비비") {
                editor.putInt("changeUparu1", R.drawable.bibi)
                editor.putString("changeType1", "불,물")
                editor.apply()
            } else if (selectedItem == "빙고") {
                editor.putInt("changeUparu1", R.drawable.bingo)
                editor.putString("changeType1", "얼음,땅")
                editor.apply()
            } else if (selectedItem == "버터핀") {
                editor.putInt("changeUparu1", R.drawable.butterfin)
                editor.putString("changeType1", "땅,천둥")
                editor.apply()
            } else if (selectedItem == "우파루파") {
                editor.putInt("changeUparu1", R.drawable.uparupa)
                editor.putString("changeType1", "땅,물")
                editor.apply()
            } else if (selectedItem == "찡요") {
                editor.putInt("changeUparu1", R.drawable.jjingyo)
                editor.putString("changeType1", "물,숲")
                editor.apply()
            } else if (selectedItem == "울라미") {
                editor.putInt("changeUparu1", R.drawable.ulami)
                editor.putString("changeType1", "얼음,땅")
                editor.apply()
            } else if (selectedItem == "울포") {
                editor.putInt("changeUparu1", R.drawable.ulfo)
                editor.putString("changeType1", "불,천둥")
                editor.apply()
            } else if (selectedItem == "엘리") {
                editor.putInt("changeUparu1", R.drawable.eli)
                editor.putString("changeType1", "물,땅")
                editor.apply()
            } else if (selectedItem == "치치") {
                editor.putInt("changeUparu1", R.drawable.chichi)
                editor.putString("changeType1", "얼음,땅")
                editor.apply()
            } else if (selectedItem == "도리") {
                editor.putInt("changeUparu1", R.drawable.dori)
                editor.putString("changeType1", "땅,얼음")
                editor.apply()
            } else if (selectedItem == "프로구") {
                editor.putInt("changeUparu1", R.drawable.progu)
                editor.putString("changeType1", "숲,물")
                editor.apply()
            } else if (selectedItem == "아르망") {
                editor.putInt("changeUparu1", R.drawable.armang)
                editor.putString("changeType1", "땅,불")
                editor.apply()
            } else if (selectedItem == "벳시") {
                editor.putInt("changeUparu1", R.drawable.betsi)
                editor.putString("changeType1", "물,불")
                editor.apply()
            } else if (selectedItem == "코쿠") {
                editor.putInt("changeUparu1", R.drawable.koku)
                editor.putString("changeType1", "불,물")
                editor.apply()
            } else if (selectedItem == "라이루") {
                editor.putInt("changeUparu1", R.drawable.rairu)
                editor.putString("changeType1", "천둥,얼음")
                editor.apply()
            } else if (selectedItem == "타마미") {
                editor.putInt("changeUparu1", R.drawable.tamami)
                editor.putString("changeType1", "얼음,천둥")
                editor.apply()
            } else if (selectedItem == "히포포") {
                editor.putInt("changeUparu1", R.drawable.hipopo)
                editor.putString("changeType1", "물,불")
                editor.apply()
            } else if (selectedItem == "스코티") {
                editor.putInt("changeUparu1", R.drawable.scoti)
                editor.putString("changeType1", "땅,불")
                editor.apply()
            } else if (selectedItem == "바렛사") {
                editor.putInt("changeUparu1", R.drawable.baretsa)
                editor.putString("changeType1", "불,땅")
                editor.apply()
            } else if (selectedItem == "단비") {
                editor.putInt("changeUparu1", R.drawable.danbi)
                editor.putString("changeType1", "땅,불")
                editor.apply()
            } else if (selectedItem == "버프루") {
                editor.putInt("changeUparu1", R.drawable.buffru)
                editor.putString("changeType1", "땅,물")
                editor.apply()
            } else if (selectedItem == "카피루") {
                editor.putInt("changeUparu1", R.drawable.copyru)
                editor.putString("changeType1", "물,땅")
                editor.apply()
            } else if (selectedItem == "투투") {
                editor.putInt("changeUparu1", R.drawable.tutu)
                editor.putString("changeType1", "바람,숲")
                editor.apply()
            } else if (selectedItem == "피구루") {
                editor.putInt("changeUparu1", R.drawable.piguru)
                editor.putString("changeType1", "숲,바람")
                editor.apply()
            } else if (selectedItem == "토드") {
                editor.putInt("changeUparu1", R.drawable.tod)
                editor.putString("changeType1", "물,불")
                editor.apply()
            } else if (selectedItem == "촘촘") {
                editor.putInt("changeUparu1", R.drawable.chomchom)
                editor.putString("changeType1", "천둥,땅")
                editor.apply()
            } else if (selectedItem == "크로펫") {
                editor.putInt("changeUparu1", R.drawable.cropet)
                editor.putString("changeType1", "천둥,땅")
                editor.apply()
            } else if (selectedItem == "꼬부") {
                editor.putInt("changeUparu1", R.drawable.ggobu)
                editor.putString("changeType1", "바람,숲")
                editor.apply()
            } else if (selectedItem == "크래피") {
                editor.putInt("changeUparu1", R.drawable.crapi)
                editor.putString("changeType1", "숲,바람")
                editor.apply()
            } else if (selectedItem == "보보") {
                editor.putInt("changeUparu1", R.drawable.bobo)
                editor.putString("changeType1", "바람,물")
                editor.apply()
            } else if (selectedItem == "몽키루") {
                editor.putInt("changeUparu1", R.drawable.mongkiru)
                editor.putString("changeType1", "천둥,얼음")
                editor.apply()
            } else if (selectedItem == "고고") {
                editor.putInt("changeUparu1", R.drawable.gogo)
                editor.putString("changeType1", "바람,불")
                editor.apply()
            } else if (selectedItem == "파이루") {
                editor.putInt("changeUparu1", R.drawable.firu)
                editor.putString("changeType1", "불,바람")
                editor.apply()
            } else if (selectedItem == "베티") {
                editor.putInt("changeUparu1", R.drawable.beti)
                editor.putString("changeType1", "얼음,천둥")
                editor.apply()
            } else if (selectedItem == "코기") {
                editor.putInt("changeUparu1", R.drawable.kogi)
                editor.putString("changeType1", "불,바람")
                editor.apply()
            } else if (selectedItem == "미코") {
                editor.putInt("changeUparu1", R.drawable.miko)
                editor.putString("changeType1", "바람,불")
                editor.apply()
            } else if (selectedItem == "맨디") {
                editor.putInt("changeUparu1", R.drawable.mendi)
                editor.putString("changeType1", "바람,불")
                editor.apply()
            } else if (selectedItem == "플라메루") {
                editor.putInt("changeUparu1", R.drawable.flameru)
                editor.putString("changeType1", "불,바람")
                editor.apply()
            } else if (selectedItem == "기로로") {
                editor.putInt("changeUparu1", R.drawable.giroro)
                editor.putString("changeType1", "바람,천둥")
                editor.apply()
            } else if (selectedItem == "스컹키") {
                editor.putInt("changeUparu1", R.drawable.skungki)
                editor.putString("changeType1", "바람,얼음")
                editor.apply()
            } else if (selectedItem == "구루루") {
                editor.putInt("changeUparu1", R.drawable.gururu)
                editor.putString("changeType1", "바람,천둥")
                editor.apply()
            } else if (selectedItem == "와우") {
                editor.putInt("changeUparu1", R.drawable.wow)
                editor.putString("changeType1", "얼음,바람")
                editor.apply()
            } else if (selectedItem == "울리") {
                editor.putInt("changeUparu1", R.drawable.uli)
                editor.putString("changeType1", "얼음,바람")
                editor.apply()
            } else if (selectedItem == "키츠") {
                editor.putInt("changeUparu1", R.drawable.kitz)
                editor.putString("changeType1", "천둥,바람")
                editor.apply()
            } else if (selectedItem == "돌리") {
                editor.putInt("changeUparu1", R.drawable.doli)
                editor.putString("changeType1", "얼음,바람")
                editor.apply()
            } else if (selectedItem == "라쿠") {
                editor.putInt("changeUparu1", R.drawable.raku)
                editor.putString("changeType1", "천둥,바람")
                editor.apply()
            } else if (selectedItem == "냐오") {
                editor.putInt("changeUparu1", R.drawable.nyao)
                editor.putString("changeType1", "천둥,바람")
                editor.apply()
            } else if (selectedItem == "코카") {
                editor.putInt("changeUparu1", R.drawable.koka)
                editor.putString("changeType1", "천둥,땅")
                editor.apply()
            } else if (selectedItem == "티고") {
                editor.putInt("changeUparu1", R.drawable.tigo)
                editor.putString("changeType1", "얼음,바람")
                editor.apply()
            } else if (selectedItem == "두두") {
                editor.putInt("changeUparu1", R.drawable.dudu)
                editor.putString("changeType1", "바람,얼음")
                editor.apply()
            } else if (selectedItem == "미요") {
                editor.putInt("changeUparu1", R.drawable.miyo)
                editor.putString("changeType1", "얼음,바람")
                editor.apply()
            } else if (selectedItem == "폴라루") {
                editor.putInt("changeUparu1", R.drawable.polaru)
                editor.putString("changeType1", "얼음,물")
                editor.apply()
            } else if (selectedItem == "마리나") {
                editor.putInt("changeUparu1", R.drawable.marina)
                editor.putString("changeType1", "물,얼음")
                editor.apply()
            } else if (selectedItem == "포기사") {
                editor.putInt("changeUparu1", R.drawable.pogisa)
                editor.putString("changeType1", "숲,불")
                editor.apply()
            } else if (selectedItem == "왈루") {
                editor.putInt("changeUparu1", R.drawable.warru)
                editor.putString("changeType1", "얼음,물")
                editor.apply()
            } else if (selectedItem == "크랑") {
                editor.putInt("changeUparu1", R.drawable.krang)
                editor.putString("changeType1", "물,바람")
                editor.apply()
            } else if (selectedItem == "두무라이") {
                editor.putInt("changeUparu1", R.drawable.dumurai)
                editor.putString("changeType1", "땅,얼음")
                editor.apply()
            } else if (selectedItem == "슈젤") {
                editor.putInt("changeUparu1", R.drawable.shujel)
                editor.putString("changeType1", "물,바람")
                editor.apply()
            } else if (selectedItem == "너구루") {
                editor.putInt("changeUparu1", R.drawable.neoguru)
                editor.putString("changeType1", "땅,매직")
                editor.apply()
            } else if (selectedItem == "츄파이킹") {
                editor.putInt("changeUparu1", R.drawable.chupiking)
                editor.putString("changeType1", "얼음,물")
                editor.apply()
            } else if (selectedItem == "샤키") {
                editor.putInt("changeUparu1", R.drawable.sharky)
                editor.putString("changeType1", "물,매직")
                editor.apply()
            } else if (selectedItem == "수리") {
                editor.putInt("changeUparu1", R.drawable.suri)
                editor.putString("changeType1", "매직,천둥")
                editor.apply()
            } else if (selectedItem == "로디") {
                editor.putInt("changeUparu1", R.drawable.rodi)
                editor.putString("changeType1", "매직,바람")
                editor.apply()
            } else if (selectedItem == "푸르니") {
                editor.putInt("changeUparu1", R.drawable.purni)
                editor.putString("changeType1", "숲,물,땅")
                editor.apply()
            } else if (selectedItem == "레스코") {
                editor.putInt("changeUparu1", R.drawable.resco)
                editor.putString("changeType1", "땅,불,물")
                editor.apply()
            } else if (selectedItem == "캐터플라이") {
                editor.putInt("changeUparu1", R.drawable.caterfly)
                editor.putString("changeType1", "불,천둥,숲")
                editor.apply()
            } else if (selectedItem == "체키루") {
                editor.putInt("changeUparu1", R.drawable.chekiru)
                editor.putString("changeType1", "땅,얼음,물")
                editor.apply()
            } else if (selectedItem == "도도") {
                editor.putInt("changeUparu1", R.drawable.dodo)
                editor.putString("changeType1", "불,천둥,바람")
                editor.apply()
            } else if (selectedItem == "쉘루") {
                editor.putInt("changeUparu1", R.drawable.shellru)
                editor.putString("changeType1", "바람,물,얼음")
                editor.apply()
            } else if (selectedItem == "펜리루") {
                editor.putInt("changeUparu1", R.drawable.penriru)
                editor.putString("changeType1", "불,얼음")
                editor.apply()
            } else if (selectedItem == "폭시") {
                editor.putInt("changeUparu1", R.drawable.foxy)
                editor.putString("changeType1", "얼음,불")
                editor.apply()
            } else if (selectedItem == "채피") {
                editor.putInt("changeUparu1", R.drawable.chepy)
                editor.putString("changeType1", "얼음,불")
                editor.apply()
            } else if (selectedItem == "바우") {
                editor.putInt("changeUparu1", R.drawable.bau)
                editor.putString("changeType1", "바람,땅")
                editor.apply()
            } else if (selectedItem == "보라도루") {
                editor.putInt("changeUparu1", R.drawable.boradoru)
                editor.putString("changeType1", "땅,바람")
                editor.apply()
            } else if (selectedItem == "유니") {
                editor.putInt("changeUparu1", R.drawable.yuni)
                editor.putString("changeType1", "얼음,숲")
                editor.apply()
            } else if (selectedItem == "봉봉") {
                editor.putInt("changeUparu1", R.drawable.bongbong)
                editor.putString("changeType1", "숲,얼음")
                editor.apply()
            } else if (selectedItem == "크레이") {
                editor.putInt("changeUparu1", R.drawable.cray)
                editor.putString("changeType1", "천둥,물")
                editor.apply()
            } else if (selectedItem == "헤르미") {
                editor.putInt("changeUparu1", R.drawable.hermi)
                editor.putString("changeType1", "천둥,물")
                editor.apply()
            } else if (selectedItem == "루돌") {
                editor.putInt("changeUparu1", R.drawable.rudol)
                editor.putString("changeType1", "불,얼음,숲")
                editor.apply()
            } else if (selectedItem == "코타") {
                editor.putInt("changeUparu1", R.drawable.kota2)
                editor.putString("changeType1", "얼음,불")
                editor.apply()
            } else if (selectedItem == "누니") {
                editor.putInt("changeUparu1", R.drawable.nuni)
                editor.putString("changeType1", "얼음,땅,바람")
                editor.apply()
            } else if (selectedItem == "알로하") {
                editor.putInt("changeUparu1", R.drawable.alroha)
                editor.putString("changeType1", "물,얼음,숲")
                editor.apply()
            } else if (selectedItem == "토토루") {
                editor.putInt("changeUparu1", R.drawable.totoru)
                editor.putString("changeType1", "얼음,땅,바람")
                editor.apply()
            } else if (selectedItem == "펌키") {
                editor.putInt("changeUparu1", R.drawable.pumki2)
                editor.putString("changeType1", "천둥,바람")
                editor.apply()
            } else if (selectedItem == "로사") {
                editor.putInt("changeUparu1", R.drawable.rosa)
                editor.putString("changeType1", "바람,얼음,숲")
                editor.apply()
            } else if (selectedItem == "티더") {
                editor.putInt("changeUparu1", R.drawable.tider)
                editor.putString("changeType1", "얼음,숲,바람")
                editor.apply()
            } else if (selectedItem == "와이키") {
                editor.putInt("changeUparu1", R.drawable.whyki)
                editor.putString("changeType1", "물,얼음,천둥")
                editor.apply()
            } else if (selectedItem == "스컬루") {
                editor.putInt("changeUparu1", R.drawable.skulru2)
                editor.putString("changeType1", "천둥,바람,얼음")
                editor.apply()
            } else if (selectedItem == "스파루몽") {
                editor.putInt("changeUparu1", R.drawable.sparumong2)
                editor.putString("changeType1", "천둥,불,얼음")
                editor.apply()
            } else if (selectedItem == "메리") {
                editor.putInt("changeUparu1", R.drawable.merry2)
                editor.putString("changeType1", "불,땅,숲")
                editor.apply()
            } else if (selectedItem == "서퍼용") {
                editor.putInt("changeUparu1", R.drawable.sufferyong2)
                editor.putString("changeType1", "물,바람,천둥")
                editor.apply()
            } else if (selectedItem == "쥬라용") {
                editor.putInt("changeUparu1", R.drawable.jurayong2)
                editor.putString("changeType1", "땅,천둥,숲")
                editor.apply()
            } else if (selectedItem == "큐피") {
                editor.putInt("changeUparu1", R.drawable.cupi2)
                editor.putString("changeType1", "매직,바람,불")
                editor.apply()
            } else if (selectedItem == "램버트") {
                editor.putInt("changeUparu1", R.drawable.rambert2)
                editor.putString("changeType1", "바람,물,숲")
                editor.apply()
            } else if (selectedItem == "애플칙") {
                editor.putInt("changeUparu1", R.drawable.applechick)
                editor.putString("changeType1", "숲,땅")
                editor.apply()
            } else if (selectedItem == "스파인") {
                editor.putInt("changeUparu1", R.drawable.spain)
                editor.putString("changeType1", "바람,천둥")
                editor.apply()
            } else if (selectedItem == "고디움") {
                editor.putInt("changeUparu1", R.drawable.godium)
                editor.putString("changeType1", "불,바람")
                editor.apply()
            } else if (selectedItem == "오미야콘") {
                editor.putInt("changeUparu1", R.drawable.omiyacon)
                editor.putString("changeType1", "얼음,땅")
                editor.apply()
            } else if (selectedItem == "오르페우스") {
                editor.putInt("changeUparu1", R.drawable.orpeus)
                editor.putString("changeType1", "땅,천둥")
                editor.apply()
            } else if (selectedItem == "피코") {
                editor.putInt("changeUparu1", R.drawable.piko2)
                editor.putString("changeType1", "물,숲,천둥")
                editor.apply()
            } else if (selectedItem == "샤샤") {
                editor.putInt("changeUparu1", R.drawable.shasha2)
                editor.putString("changeType1", "땅,얼음,천둥")
                editor.apply()
            } else if (selectedItem == "새치미") {
                editor.putInt("changeUparu1", R.drawable.sechimi2)
                editor.putString("changeType1", "얼음,바람,불")
                editor.apply()
            } else if (selectedItem == "원더드래곤") {
                editor.putInt("changeUparu1", R.drawable.wonderdragon)
                editor.putString("changeType1", "천둥,바람,물")
                editor.apply()
            } else if (selectedItem == "유리온") {
                editor.putInt("changeUparu1", R.drawable.yurion)
                editor.putString("changeType1", "물,얼음")
                editor.apply()
            } else if (selectedItem == "포포모") {
                editor.putInt("changeUparu1", R.drawable.popomo)
                editor.putString("changeType1", "불,숲,물")
                editor.apply()
            } else if (selectedItem == "머쉬룸") {
                editor.putInt("changeUparu1", R.drawable.mushroom2)
                editor.putString("changeType1", "땅,불")
                editor.apply()
            } else if (selectedItem == "샤크곤") {
                editor.putInt("changeUparu1", R.drawable.sharkgon2)
                editor.putString("changeType1", "물,얼음")
                editor.apply()
            } else if (selectedItem == "애플칙S") {
                editor.putInt("changeUparu1", R.drawable.applechick22)
                editor.putString("changeType1", "숲,땅")
                editor.apply()
            } else if (selectedItem == "달구루") {
                editor.putInt("changeUparu1", R.drawable.dalguru)
                editor.putString("changeType1", "숲,매직")
                editor.apply()
            } else if (selectedItem == "테디") {
                editor.putInt("changeUparu1", R.drawable.tedi)
                editor.putString("changeType1", "매직,땅")
                editor.apply()
            } else if (selectedItem == "밤쿠리") {
                editor.putInt("changeUparu1", R.drawable.bamkuri)
                editor.putString("changeType1", "땅,매직")
                editor.apply()
            } else if (selectedItem == "메토루") {
                editor.putInt("changeUparu1", R.drawable.metoru)
                editor.putString("changeType1", "매직,숲")
                editor.apply()
            } else if (selectedItem == "젤리시아") {
                editor.putInt("changeUparu1", R.drawable.jelisia)
                editor.putString("changeType1", "매직,숲")
                editor.apply()
            } else if (selectedItem == "푸스") {
                editor.putInt("changeUparu1", R.drawable.pus)
                editor.putString("changeType1", "천둥,매직")
                editor.apply()
            } else if (selectedItem == "실리") {
                editor.putInt("changeUparu1", R.drawable.silli)
                editor.putString("changeType1", "매직,물")
                editor.apply()
            } else if (selectedItem == "돌피") {
                editor.putInt("changeUparu1", R.drawable.dolpi)
                editor.putString("changeType1", "물,매직")
                editor.apply()
            } else if (selectedItem == "클리네") {
                editor.putInt("changeUparu1", R.drawable.cline)
                editor.putString("changeType1", "천둥,매직")
                editor.apply()
            } else if (selectedItem == "험프티") {
                editor.putInt("changeUparu1", R.drawable.humpti)
                editor.putString("changeType1", "매직,천둥")
                editor.apply()
            } else if (selectedItem == "팬디") {
                editor.putInt("changeUparu1", R.drawable.pandi)
                editor.putString("changeType1", "바람,매직")
                editor.apply()
            } else if (selectedItem == "팅클루") {
                editor.putInt("changeUparu1", R.drawable.tingklru)
                editor.putString("changeType1", "매직,바람")
                editor.apply()
            } else if (selectedItem == "펜펜") {
                editor.putInt("changeUparu1", R.drawable.penpen)
                editor.putString("changeType1", "매직,얼음")
                editor.apply()
            } else if (selectedItem == "소프티") {
                editor.putInt("changeUparu1", R.drawable.softi)
                editor.putString("changeType1", "얼음,매직")
                editor.apply()
            } else if (selectedItem == "아르키") {
                editor.putInt("changeUparu1", R.drawable.arki)
                editor.putString("changeType1", "얼음,매직")
                editor.apply()
            } else if (selectedItem == "듀장군") {
                editor.putInt("changeUparu1", R.drawable.dujangun)
                editor.putString("changeType1", "물,매직")
                editor.apply()
            } else if (selectedItem == "드라펫") {
                editor.putInt("changeUparu1", R.drawable.drapet)
                editor.putString("changeType1", "매직,천둥")
                editor.apply()
            } else if (selectedItem == "알파") {
                editor.putInt("changeUparu1", R.drawable.alpha)
                editor.putString("changeType1", "불,매직")
                editor.apply()
            } else if (selectedItem == "토이보") {
                editor.putInt("changeUparu1", R.drawable.toibo)
                editor.putString("changeType1", "매직,불")
                editor.apply()
            } else if (selectedItem == "덤프티") {
                editor.putInt("changeUparu1", R.drawable.dumpti)
                editor.putString("changeType1", "매직,불")
                editor.apply()
            } else if (selectedItem == "캔디럽") {
                editor.putInt("changeUparu1", R.drawable.candylove2)
                editor.putString("changeType1", "얼음,천둥")
                editor.apply()
            } else if (selectedItem == "베르") {
                editor.putInt("changeUparu1", R.drawable.berr2)
                editor.putString("changeType1", "물,바람,땅")
                editor.apply()
                ...
                editor.putString("changeType1", "얼음,땅")
                editor.apply()
            } else if (selectedItem == "마이티") {
                editor.putInt("changeUparu1", R.drawable.myti2)
                editor.putString("changeType1", "얼음,불,매직")
                editor.apply()
            } else if (selectedItem == "팡팡") {
                editor.putInt("changeUparu1", R.drawable.pangpang2)
                editor.putString("changeType1", "바람,매직,숲")
                editor.apply()
            } else if (selectedItem == "카프리") {
                editor.putInt("changeUparu1", R.drawable.capri)
                editor.putString("changeType1", "매직,바람,숲")
                editor.apply()
            } else if (selectedItem == "에이프릴") {
                editor.putInt("changeUparu1", R.drawable.april)
                editor.putString("changeType1", "땅,바람,얼음")
                editor.apply()
            } else if (selectedItem == "피키") {
                editor.putInt("changeUparu1", R.drawable.piki)
                editor.putString("changeType1", "매직,숲,천둥")
                editor.apply()
            } else if (selectedItem == "레오르") {
                editor.putInt("changeUparu1", R.drawable.reor)
                editor.putString("changeType1", "땅,천둥,불")
                editor.apply()
            } else if (selectedItem == "미니드래곤") {
                editor.putInt("changeUparu1", R.drawable.minidragon)
                editor.putString("changeType1", "숲,바람")
                editor.apply()
            } else if (selectedItem == "트럼캣") {
                editor.putInt("changeUparu1", R.drawable.trumcat)
                editor.putString("changeType1", "불,바람,천둥")
                editor.apply()
            } else if (selectedItem == "바나덕") {
                editor.putInt("changeUparu1", R.drawable.banaduck)
                editor.putString("changeType1", "숲,천둥")
                editor.apply()
            } else if (selectedItem == "포토비") {
                editor.putInt("changeUparu1", R.drawable.photobi)
                editor.putString("changeType1", "천둥,매직")
                editor.apply()
            } else if (selectedItem == "덕키") {
                editor.putInt("changeUparu1", R.drawable.ducki)
                editor.putString("changeType1", "매직,바람")
                editor.apply()
            } else if (selectedItem == "꿀소리") {
                editor.putInt("changeUparu1", R.drawable.ggulsori)
                editor.putString("changeType1", "바람,얼음")
                editor.apply()
            } else if (selectedItem == "테너펭") {
                editor.putInt("changeUparu1", R.drawable.tenerpeng)
                editor.putString("changeType1", "얼음,물")
                editor.apply()
            } else if (selectedItem == "뭉치") {
                editor.putInt("changeUparu1", R.drawable.mungchi)
                editor.putString("changeType1", "땅,매직,천둥")
                editor.apply()
            } else if (selectedItem == "베일드") {
                editor.putInt("changeUparu1", R.drawable.beild)
                editor.putString("changeType1", "땅,물,숲")
                editor.apply()
            } else if (selectedItem == "헬싱포") {
                editor.putInt("changeUparu1", R.drawable.helsingpo)
                editor.putString("changeType1", "불,땅,물")
                editor.apply()
            } else if (selectedItem == "유니핀") {
                editor.putInt("changeUparu1", R.drawable.yunipin)
                editor.putString("changeType1", "얼음,물,바람")
                editor.apply()
            } else if (selectedItem == "차우파") {
                editor.putInt("changeUparu1", R.drawable.chaupa)
                editor.putString("changeType1", "땅,천둥,물")
                editor.apply()
            } else if (selectedItem == "챠오") {
                editor.putInt("changeUparu1", R.drawable.chao)
                editor.putString("changeType1", "숲,불,얼음")
                editor.apply()
            } else if (selectedItem == "킥피그") {
                editor.putInt("changeUparu1", R.drawable.kickpig)
                editor.putString("changeType1", "불,숲,천둥")
                editor.apply()
            } else if (selectedItem == "피싱키") {
                editor.putInt("changeUparu1", R.drawable.pisingki)
                editor.putString("changeType1", "숲,얼음,바람")
                editor.apply()
            } else if (selectedItem == "우콩") {
                editor.putInt("changeUparu1", R.drawable.ukong)
                editor.putString("changeType1", "숲,매직,천둥")
                editor.apply()
            } else if (selectedItem == "보더") {
                editor.putInt("changeUparu1", R.drawable.boder)
                editor.putString("changeType1", "숲,매직,불")
                editor.apply()
            } else if (selectedItem == "에비누") {
                editor.putInt("changeUparu1", R.drawable.ebinu)
                editor.putString("changeType1", "얼음,불")
                editor.apply()
            }
            startActivity(intent)
