...
class SelectSecondParentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                startActivity(Intent(this@SelectSecondParentActivity, BreedingResultActivity::class.java))
                finishAffinity()
        ...
        val newAdapter = UparuGridAdapter(this@SelectSecondParentActivity, sortedDataList)
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                if (newText != null) {
                    ...
                    val newAdapter =
                        UparuGridAdapter(this@SelectSecondParentActivity, filteredDataList)
                    gridView.adapter = newAdapter
                }
                return true
            }
