...
class SummonTimeItem(val profile:Int, val name:String, val egg:Int, val st:String, val time:String)

class SummonTimeAdapter(val context: Context, var dataList: ArrayList<SummonTimeItem>) :
    RecyclerView.Adapter<SummonTimeAdapter.ViewHolder>() {
